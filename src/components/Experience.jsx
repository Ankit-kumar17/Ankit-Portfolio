...
const experiences = [
  {
    ...
    type: "work",
    description:
      "Leading the frontend architecture for the core flagship product. Improved application performance by 40%.",
    highlights: [
      "Migrated legacy codebase to React 18",
  ...
  },
  {
    ...
    type: "work",
    description:
      "Developed interactive UI components for various client portfolios and internal dashboards.",
    highlights: [
      "Built custom Tailwind UI components",
      "Reduced API payload size by integrating GraphQL",
    ],
  },
  {
            ...
            {experiences.map((exp, index) => {
              ...
              return (
                ...
                >
                  {/* Timeline Dot */}
                  <div
                    className={`absolute left-4 md:left-1/2 w-10 h-10 rounded-full border-4 border-background bg-primary/10 flex items-center justify-center transform -translate-x-1/2 z-10 shadow-[0_0_15px_hsl(177_70%_50%/0.3)]`}
                  >
                    {exp.type === "work" ? (
                  ...
                  <div
                    className={`hidden md:block w-1/2 ${isEven ? "order-1 pr-12" : "order-2 pl-12"}`}
                  >
                    {isEven && (
                  ...
                  <div
                    className={`w-full md:w-1/2 pl-16 md:pl-0 ${isEven ? "md:hidden" : "md:pl-12 order-2"}`}
                  >
