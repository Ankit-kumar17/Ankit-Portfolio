...
const projects = [
  {
    ...
    description:
      "Built a full-stack e-commerce application using React, Node.js, and MongoDB. Implemented product listings, search & filter, cart functionality, and user authentication.",
    icon: ShoppingCart,
    technologies: ["React", "Node.js", "MongoDB", "Express"],
    gradient: "from-primary to-cyan-400",
    caseStudy: {
      problem:
        "Local businesses lacked a unified, affordable platform to transition their sales online with customized inventory management.",
      solution:
        "Developed a scalable full-stack application that provides an intuitive admin dashboard and a seamless shopping experience for customers.",
      features: [
  ...
  },
  {
    ...
    description:
      "Created a responsive task manager with React and REST APIs. Users can create, update, delete, and track daily tasks with real-time UI updates.",
    icon: CheckSquare,
    technologies: ["React", "REST API", "CSS", "JavaScript"],
    gradient: "from-accent to-purple-400",
    caseStudy: {
      problem:
        "Teams struggled with context switching between heavy project management tools for simple daily tasks.",
      solution:
        "Designed a lightweight, lightning-fast Kanban-style board focused entirely on daily micro-tasks to boost developer productivity.",
      features: [
  ...
  },
  {
    ...
    description:
      "Designed and developed a personal portfolio using React showcasing skills, projects, and contact features with a modern and mobile-friendly design.",
    icon: User,
    technologies: ["React", "Tailwind CSS", "Framer Motion"],
    gradient: "from-emerald-500 to-teal-400",
    caseStudy: {
      problem:
        "Standard text resumes failed to adequately display interactive frontend skills and design systems.",
      solution:
        "Engineered a world-class, premium glassmorphic portfolio utilizing modern UI patterns to act as a living resume and interactive playground.",
      features: [
        "Dark mode native",
        "Responsive Framer animations",
            ...
            <motion.div key={project.title} variants={itemVariants}>
              <Dialog>
                ...
                <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-y-auto border-white/20 bg-background/95 backdrop-blur-xl p-0">
                  <div
                    className={`p-8 bg-gradient-to-br ${project.gradient} relative overflow-hidden`}
                  >
                    {/* Pattern Overlay */}
                    <div className="absolute inset-0 opacity-20">
                      <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.1)_25%,rgba(255,255,255,0.1)_50%,transparent_50%,transparent_75%,rgba(255,255,255,0.1)_75%)] bg-[length:20px_20px]" />
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {project.technologies.map((tech) => (
                            <span
                              key={tech}
                              className="text-xs px-2 py-1 bg-black/30 rounded text-white/90"
                            >
                              {tech}
                            </span>
                          ))}
                    ...
                    <section>
                      ...
                      <ul className="grid sm:grid-cols-2 gap-3">
                        {project.caseStudy.features.map((feature, i) => (
                          <li
                            key={i}
                            className="flex items-center gap-2 text-muted-foreground bg-secondary/50 p-3 rounded-lg border border-white/5"
                          >
