      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed text-center">
            I am a passionate frontend developer specializing in React. I love
            building clean and user-friendly web applications and aim to work at
            a product-based company where I can contribute to meaningful
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="glass-card p-5 rounded-xl hover:border-primary/50 transition-all duration-300 group hover:-translate-y-1">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Swaminarayan University • 2025–2029
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Creating responsive, accessible, and visually appealing web
                experiences. Turning ideas into reality with clean code and
                modern technologies.
              </p>
            </motion.div>
          </div>
